...
example_query = "Create a 3D rotating cube with colored faces using pygame and basic 3D projection math"
query = st.text_area(
    ...
    try:
        ...
        with st.spinner("Generating solution..."):
            deepseek_response = deepseek_client.chat.completions.create(
                ...
                max_tokens=8192  # increased from 1 — original value was clearly a bug/placeholder
            )
